...
const o = document.querySelector("#dato15")
...
quince = document.getElementById("funcionales").value
di = document.getElementById("caracteristicas").value
// localstorege
...
localStorage.setItem("funcionalidades",quince);
localStorage.setItem("caracteristicas",di);
...
document.getElementById("funcionales").value = "";
...
quince = localStorage.getItem("funcionalidades");
di = localStorage.getItem("caracteristicas");
//mostrar datos
a.innerHTML = uno;
b.innerHTML = dos;
c.innerHTML = tres;
